        ...
        <div className="bg-[#fcfcfc] min-h-screen">
            ...
            <div className="bg-primary pt-32 pb-24 text-center text-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    <span className="text-secondary font-bold tracking-widest uppercase text-sm mb-4 block">Album Dokumentasi</span>
                    <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4">{item.title}</h1>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                {item.images.filter(img => img.published).map((photo) => (
                                    <Link
                                        ...
                                        className="group relative aspect-[4/3] rounded-xl overflow-hidden bg-gray-100 shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 block"
                                    >
